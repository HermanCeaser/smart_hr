<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-20 text-center lg:pt-32">
    ...
    <p class="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Most bookkeeping software is accurate, but hard to use. We make the opposite trade-off, and hope you don’t
        get audited.
    </p>
            ...
            <li>
                <ul role="list" class="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
                    <li class="flex"><img alt="Transistor" loading="lazy" width="158" height="48"
                            ...
                            src="{{ asset('images/partners/transistor.7274e6c3.svg') }}"
                            style="color: transparent;"></li>
                    <li class="flex"><img alt="Tuple" loading="lazy" width="105" height="48"
                            decoding="async" data-nimg="1" src="{{ asset('images/partners/tuple.74eb0ae0.svg') }}"
                            style="color: transparent;"></li>
                    <li class="flex"><img alt="StaticKit" loading="lazy" width="127" height="48"
                            decoding="async" data-nimg="1"
                            src="{{ asset('images/partners/statickit.d7937794.svg') }}"
                            style="color: transparent;"></li>
                </ul>
            </li>
            <li>
                <ul role="list" class="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
                    <li class="flex"><img alt="Mirage" loading="lazy" width="138" height="48"
                            decoding="async" data-nimg="1"
                            src="{{ asset('images/partners/mirage.18d2ec4e.svg') }}" style="color: transparent;">
                    </li>
                    <li class="flex"><img alt="Laravel" loading="lazy" width="136" height="48"
                            decoding="async" data-nimg="1"
                            src="{{ asset('images/partners/laravel.7deed17e.svg') }}" style="color: transparent;">
                    </li>
                    <li class="flex"><img alt="Statamic" loading="lazy" width="147" height="48"
                            decoding="async" data-nimg="1"
                            src="{{ asset('images/partners/statamic.6da5ebfb.svg') }}"
                            style="color: transparent;"></li>
                </ul>
            </li>
        </ul>
